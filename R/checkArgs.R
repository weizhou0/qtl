...
checkArgsListNumeric <- function(
  ...
  checkArgNumeric(SPAcutoff, deparse(substitute(SPAcutoff)), 0.00000001, 10000)
...
checkArgsList_for_Region <- function(MACCutoff_to_CollapseUltraRare,
                                     maxMAF_in_groupTest,
  ...
  cat(
    "Ultra rare variants with MAC <= ", MACCutoff_to_CollapseUltraRare,
