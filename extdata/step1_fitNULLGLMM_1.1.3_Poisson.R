...
# library(SAIGE, lib.loc="/net/hunt/zhowei/project/imbalancedCaseCtrlMixedModel/Rpackage_SPAGMMAT/SAIGE_newgit/install_1.1.3_Poisson")
...
# library(SAIGE, lib.loc="/net/csgspare3/snowwhite.archive/zczhao/SAIGE-GENE-UPDATE/eqtl/simulation/SAIGE_test/install")
...
option_list <- list(
  ...
  make_option("--useGRMtoFitNULL", type = "logical", default = FALSE, help = ""),
