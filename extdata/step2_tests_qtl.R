...
option_list <- list(
  ...
  make_option("--rangestoIncludeFile",
    type = "character", default = "",
  ...
  make_option("--minGroupMAC_in_BurdenTest",
  ...
  make_option("--is_output_moreDetails",
    type = "logical", default = FALSE,
  ...
  make_option("--is_overwrite_output",
    type = "logical", default = TRUE,
  ...
  make_option("--maxMAF_in_groupTest",
    type = "character", default = "0.0001,0.001,0.01",
    help = "Max MAF for markers tested in group test seperated by comma. e.g. 0.0001,0.001,0.01, [default=0.01]"
  ),
  make_option("--minMAF_in_groupTest_Exclude",
  ...
  make_option("--maxMAC_in_groupTest",
  ...
  make_option("--minMAC_in_groupTest_Exclude",
    type = "character", default = NULL,
  ...
  make_option("--annotation_in_groupTest",
    type = "character", default = "lof,missense;lof,missense;lof;synonymous",
  ...
  make_option("--MACCutoff_to_CollapseUltraRare",
  ...
  make_option("--weights.beta",
    type = "character", default = "1;25",
  ...
  make_option("--markers_per_chunk_in_groupTest",
    type = "numeric", default = 100,
  ...
  make_option("--weights_for_condition",
    type = "character", default = NULL,
...
mean, p-value based on traditional score test is returned. Default value is 2."
  ...
  make_option("--dosage_zerod_cutoff",
  ...
  make_option("--dosage_zerod_MAC_cutoff",
    type = "numeric", default = 10,
  ...
  make_option("--is_single_in_groupTest",
    type = "logical", default = FALSE,
  ...
  make_option("--is_SKATO",
    type = "logical", default = FALSE,
    help = "whether to perform SKAT-O test [default=FALSE]"
  ),
  make_option("--is_equal_weight_in_groupTest",
    type = "logical", default = FALSE,
