...
library(SAIGE, lib.loc = "/net/hunt/zhowei/project/imbalancedCaseCtrlMixedModel/Rpackage_SPAGMMAT/SAIGE_newgit/SAIGE_1.1.3_github/install_1.1.6")
...
mean, p-value based on traditional score test is returned. Default value is 2."
  ...
  make_option("--is_no_weight_in_groupTest",
    type = "logical", default = FALSE,
