#!/bin/bash
# SAIGEQTL Installation Script for macOS
#
...
echo "=============================================="
echo "SAIGEQTL Installation Script for macOS"
echo "=============================================="
echo ""
echo "This script uses Miniforge (free, open-source conda) to install"
echo "SAIGEQTL with all required dependencies."
echo ""
...
if command -v mamba &> /dev/null; then
    ...
    bash "Miniforge3-MacOSX-${ARCH}.sh" -b -p "$HOME/miniforge3"
    rm "Miniforge3-MacOSX-${ARCH}.sh"
...
mkdir -p ~/.R
cat > ~/.R/Makevars << EOF
# macOS conda environment configuration for SAIGEQTL
